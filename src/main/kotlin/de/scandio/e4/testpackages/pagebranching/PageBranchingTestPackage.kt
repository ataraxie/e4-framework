...
class PageBranchingTestPackage: TestPackage {
    ...
    override fun getSetupActions(): ActionCollection {
        ...
        actions.add(CreateSpaceAction(REQUIRED_SPACEKEY, spaceName))

        actions.add(AddSpaceGroupPermissionAction(REQUIRED_SPACEKEY, "confluence-users", "removepage", true))

        // Assumption for BranchedPageReader and OriginPageReader
        actions.add(CreatePageAction(REQUIRED_SPACEKEY, originPageTitle))
        actions.add(CreateBranchAction(REQUIRED_SPACEKEY, originPageTitle, "Branch 1"))
        ...
        actions.add(CreateOverviewPageAction(REQUIRED_SPACEKEY, originPageTitle))
