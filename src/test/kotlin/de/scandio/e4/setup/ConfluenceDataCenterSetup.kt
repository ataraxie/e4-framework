...
//            webConfluence.setLogLevel("co.goodsoftware", "INFO")
    ...
    fun setupDatabase() {
        ...
        driver!!.navigate().to(E4Env.APPLICATION_BASE_URL) // TODO use webConfluence.navigateTo
        ...
        dom.insertText("#confLicenseString", E4Env.APPLICATION_LICENSE)
    ...
    private fun pollTillDbReady() {
        ...
        while (true) {
            ...
            driver!!.navigate().to(E4Env.APPLICATION_BASE_URL)
            dom.awaitSeconds(10)
