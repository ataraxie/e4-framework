...
# BEGIN: EDIT
# Given by --env: $NODE_NUMBER, $E4_PROV_KEY, $E4_APP_VERSION, $E4_NODE_HEAP, $E4_APP_NAME, $E4_APP_VERSION_DOT_FREE
# END: EDIT
...
export DATABASE_HOST="confluence-cluster-${E4_APP_VERSION_DOT_FREE}-db"
...
export SYNCHRONY_URL="http://confluence-cluster-${E4_APP_VERSION_DOT_FREE}-lb:2${E4_APP_VERSION_DOT_FREE}/synchrony"
...
then
  ...
  curl --connect-timeout 180 --max-time 180 --fail -o /tmp/confluence-home.tar  http://confluence-cluster-${E4_APP_VERSION_DOT_FREE}-node1:8888/download
